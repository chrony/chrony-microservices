package br.com.chrony.controller;
...
import br.com.chrony.converters.NumberConverter;
import br.com.chrony.exception.UnsuportedMathOperationException;
import br.com.chrony.math.SimpleMath;
...
public class MathController {
    ...
    public Double division(@PathVariable("numberOne") String numberOne, @PathVariable("numberTwo") String numberTwo) throws Exception {
        ...
        if (NumberConverter.convertToDouble(numberTwo).equals(0D)) {
            throw new UnsuportedMathOperationException("Divisão por zero!");
        }
